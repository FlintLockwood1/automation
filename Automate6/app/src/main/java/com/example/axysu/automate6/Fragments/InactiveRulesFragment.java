 ...
 */
public class InactiveRulesFragment extends Fragment implements CustomDialogInterface {
...
//                myAdapter.notifyDataSetChanged();
        ...
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(myReceiver2,filter);
        return layout;
    }
